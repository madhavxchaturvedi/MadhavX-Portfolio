...
function SplashCursor({
  ...
  BACK_COLOR = { r: 0.36, g: 0.11, b: 0.52 }, // Purple background
  TRANSPARENT = true,
  ...
  useEffect(() => {
    ...
    function generateColor() {
      if (usePrimaryColors) {
        // Primary color palette based on #5318fa
        const primaryColors = [
          { r: 0xe6 / 255, g: 0xd9 / 255, b: 0xff / 255 }, // #e6d9ff - very light
          { r: 0xc9 / 255, g: 0xad / 255, b: 0xff / 255 }, // #c9adff - light
          { r: 0xad / 255, g: 0x80 / 255, b: 0xff / 255 }, // #ad80ff - lighter
          { r: 0x90 / 255, g: 0x54 / 255, b: 0xff / 255 }, // #9054ff - light-medium
          { r: 0x53 / 255, g: 0x18 / 255, b: 0xfa / 255 }, // #5318fa - primary
          { r: 0x45 / 255, g: 0x13 / 255, b: 0xc7 / 255 }, // #4513c7 - dark
          { r: 0x37 / 255, g: 0x0f / 255, b: 0x95 / 255 }, // #370f95 - darker
          { r: 0x2a / 255, g: 0x0b / 255, b: 0x73 / 255 }, // #2a0b73 - darkest
          { r: 0x1f / 255, g: 0x08 / 255, b: 0x56 / 255 }, // #1f0856 - deepest
        ];
